roms := warpred.gb warpblue.gb

warpred_obj := audio_red.o main_red.o text_red.o wram_red.o
warpblue_obj := audio_blue.o main_blue.o text_blue.o wram_blue.o
...
clean:
	rm -f $(roms) $(warpred_obj) $(warpblue_obj) $(roms:.gb=.sym)
...
$(warpred_obj): %_red.o: %.asm $$(dep)
	$(RGBASM) -D _RED -h -o $@ $*.asm

%_blue.o: dep = $(shell tools/scan_includes $(@D)/$*.asm)
$(warpblue_obj): %_blue.o: %.asm $$(dep)
	$(RGBASM) -D _BLUE -h -o $@ $*.asm

warpred_opt  = -jsv -k 01 -l 0x33 -m 0x13 -p 0 -r 03 -t "WARP RED"
warpblue_opt = -jsv -k 01 -l 0x33 -m 0x13 -p 0 -r 03 -t "WARP BLUE"
